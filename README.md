...
- 2023년 11월 16일 ~ 2023년 11월 24일 (9일)👋
  ...
  | 11/17(금) | 1. 네이버 뉴스 검색 api<br />2. 내정보구성(user테이블)<br />3. 은행상품데이터 출력 | 1-1. 불러오는데 오류가 있었다.<br />2-1. <br />3-1. 은행 명을 기준으로 출력<br />3-2. 17일 18시 ~ 19일 0시 까지 api서버 점검 | 1-1-1. 코드리뷰 3시간만에 찾아낸 오류 : 두가지 코드 중 하나에 키 값이 누락되었다....<br /><br /><br />3-2-1. 해당 자료를 json파일로 저장(.py) |
  | 11/18(토) |                                                              | 빛빛빛 시험 날!!!!!                                          |                                                              |
  | 11/19(일) |                                                              |                                                              |                                                              |
  | 11/20(월) |                                                              |                                                              |                                                              |
  | 11/21(화) |                                                              |                                                              |                                                              |
