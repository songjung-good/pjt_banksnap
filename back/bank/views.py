...
def deposit(request, type):
  ...
  elif type == 'savingBank':
    depositProducts = get_list_or_404(DepositProduct, deposit_type=3)
...
def price(request):
  item_lst = [
    ...
    ["옥수수", "https://finance.naver.com/marketindex/materialDetail.naver?marketindexCd=CMDT_C", "센트/부셸"]
  ]
